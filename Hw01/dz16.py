...
# во фразе несколько слов, то они разделяются дефисами. Фразы отделяются друг от друга
...
string=(input('Введите стихотворение(если во фразе несколько слов напишите через дефис): '))
string=string.split()
itog=[]
